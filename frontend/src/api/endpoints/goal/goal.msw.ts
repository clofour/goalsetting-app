...
export const getGetApiGoalGetResponseMock = (): NorthStarGet[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({description: faker.string.alpha({length: {min: 10, max: 200}}), importance: faker.number.int(), justification: faker.string.alpha({length: {min: 10, max: 5000}}), bearings: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({northStarId: faker.string.uuid(), description: faker.string.alpha({length: {min: 10, max: 5000}}), justification: faker.string.alpha({length: {min: 10, max: 5000}}), strengths: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), weaknesses: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), movements: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({bearingId: faker.string.uuid(), difficulty: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), motivationType: faker.helpers.arrayElement([null,faker.number.int(),]), motivation: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), triggers: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), temptations: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), obstacles: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), killConditions: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 5000}}), null]), null]), id: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 200}})})), id: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 200}})})), id: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 200}})})))
