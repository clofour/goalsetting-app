...
export const getGetApiReflectionGetResponseMock = (overrideResponse: Partial<Extract<ReflectionGet, object>> = {}): ReflectionGet => ({id: faker.string.uuid(), eventId: faker.helpers.arrayElement([faker.string.uuid(), undefined]), positive: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), negative: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), improvement: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), ...overrideResponse})

export const getGetApiReflectionListResponseMock = (): ReflectionGet[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), eventId: faker.helpers.arrayElement([faker.string.uuid(), undefined]), positive: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), negative: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), improvement: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])})))
