...
export const getGetApiEventGetResponseMock = (): EventGet[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.helpers.arrayElement([{type: faker.helpers.arrayElement(['onetime'] as const), id: faker.string.uuid(), movementId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.uuid(), null]), null]), title: faker.string.alpha({length: {min: 10, max: 200}}), start: faker.date.past().toISOString().slice(0, 19) + 'Z', end: faker.date.past().toISOString().slice(0, 19) + 'Z'},{type: faker.helpers.arrayElement(['recurring'] as const), recurrence: {rrule: faker.string.alpha({length: {min: 10, max: 20}}), exDate: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))}, id: faker.string.uuid(), movementId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.uuid(), null]), null]), title: faker.string.alpha({length: {min: 10, max: 200}}), start: faker.date.past().toISOString().slice(0, 19) + 'Z', end: faker.date.past().toISOString().slice(0, 19) + 'Z'},]))))
